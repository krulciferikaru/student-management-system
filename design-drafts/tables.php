...
<div class="container-xxl p-4 rounded" style="background-color:white;">
    ...
    <table id="coursesTable" class="table table-hover table-bordered table-responsive">
        <thead>
            <tr>
                <th>#</th>
                <th>Course ID</th>
        ...
        <tbody>
            ...
            <?php if (empty($courses)): ?>
                <tr><td colspan="12" class="text-center">No courses found.</td></tr>
            <?php else: ?>
