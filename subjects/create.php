...
$courses = Course::all();
$instructors = User::allActiveInstructors();
...
<div class="container vh-100 d-flex align-items-center justify-content-center position-relative">
    <div class="glass-container d-flex flex-column mx-auto position-relative w-100" style="max-width: 55%;">
        ...
        <!-- Header -->
        <h2 class="text-center" id="black-text">Add Subject</h2>

        <form action="store.php" method="POST">
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="code" id="black-text">Subject Code</label>
                    <input type="text" class="form-control" id="code" name="code" readonly value="<?= date('YmdHis') ?>">
                </div>
                <div class="col-md-6">
                    <label for="catalog_no" id="black-text">Catalog No</label>
                    <input type="text" class="form-control" id="catalog_no" name="catalog_no" required>
                </div>
            </div>
